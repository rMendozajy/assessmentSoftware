...
<div id="contenedor">
    	...
    	<div id="contenido_izq">        	
            ...
            <div id="seccion1_izq">
                ...
                <div class="bottom">
                    <form action="index.jsp">                   
                     <h2 align="left"><bean:message key="lista.bienvenidoRe"/><br><bean:write name="user" property="nombre"/> <bean:write name="user" property="apellido_p"/></h2><br>
            ...
            <div id="section2_izq">
             <div class="top">
                ...
                <div class="bottom">
                	<ul>
                		<li><a href="responsable.do?acc=regsoft" target="contenido"><bean:message key="lista.regsoft"/></a></li>
                		<li><a href="responsable.do?acc=soft2" target="contenido"><bean:message key="lista.asigsoftdoce"/></a></li>
                        <li><a href="responsable.do?acc=soft" target="contenido" ><bean:message key="lista.asigespesoft"/></a></li>                                                                                         
					</ul>   
					<br><br> 					           
            	</div>
            </div>   
	...
	<div id="templatemo_footer">
        <a href="Responsable.jsp"><bean:message key="lista.casa"/></a> | <a href="Acerca.jsp" target="contenido"><bean:message key="lista.acerca"/></a> | <a href="Servicios.jsp" target="contenido"><bean:message key="lista.servicios"/></a> | <a href="Docente.jsp"><bean:message key="lista.soluciones"/></a> | <a href="Contact.jsp" target="contenido"><bean:message key="lista.contactenos"/></a><br />
