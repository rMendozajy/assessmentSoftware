...
<fieldset>
	<legend class="h3"><bean:message key="lista.asigsoft"/></legend>
	<br><br>
	<form action="responsable.do" method="post" id="formID">
	<input type="hidden" name="acc" value="asignaE">
	<table align="center">
	  	 <tr>
         <td><h1><bean:message key="lista.asigespe"/></h1><br><br> </td>
       <tr>
	  	<tr>
	  		<td></td>
	        <td><p><bean:message key="lista.espe"/><br></p></td>     
	        <td><select name="codUsuario" id="codUsuario" class="validate[required]">
	        	<option value=""><bean:message key="lista.elija"/></option>
	        	<logic:iterate id="especialistas" name="listaesp">
		      	  <option value="<bean:write name="especialistas" property="login"/>">          		
		          		<bean:write name="especialistas" property="nombre"/> <bean:write name="especialistas" property="apellido_p"/>
		          		<bean:write name="especialistas" property="apellido_m"/>  		
		         </logic:iterate>	        	     	
	        </select></td>
	    </tr>
	    <tr>
