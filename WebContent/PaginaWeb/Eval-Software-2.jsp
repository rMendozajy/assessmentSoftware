...
<fieldset style="width: 650px">
	...
	<input type="hidden" name="acc" value="eval2">
	...
	<input type="hidden" name="login" value="<bean:write name="login" property="login"/>">
		<table align="left" style="margin-left: 50px" width="550px">
    		...
    		<tr>  				
    			<td><h1><bean:message key="lista.aspepeda"/></h1><input type="hidden" name="estoyEn" value="item003"><input type="hidden" name="flageval" value="0"></td>
    		</tr>    						
			<tr>					
    			<td><br><h4><bean:message key="lista.item2"/></h4></td>
    		</tr>
    		<tr>  				
			...
			<tr>
				...
				<bean:message key="lista.contiayudaasist"/><br><br>
					<input type="hidden" name="codPreg1" value="preg005">
			...
			<tr>
				...
				<bean:message key="lista.contiayudaasist2"/><br><br>
					<input type="hidden" name="codPreg2" value="preg006">
			...
			<tr>
				...
				<bean:message key="lista.contiayudaasist3"/><br><br>
					<input type="hidden" name="codPreg3" value="preg007">
			...
			<tr>
				...
				<bean:message key="lista.contiayudaasist4"/><br><br>
					<input type="hidden" name="codPreg4" value="preg008">
			...
			<tr align="right">
           		<td  style="padding-top: 20px" colspan="3"><input class="send_btn2" type="submit" name="validar" value="Seguir"></td>
            </tr>				
		</table>
	</form>
</fieldset>
